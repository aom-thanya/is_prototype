...
import { ArrowLeft, Plus, Trash01, UploadCloud02, CheckCircle, AlertCircle } from '@untitledui/icons';
...
export default function CreateBrief() {
  ...
  const handlePlatformChange = (platform, isSelected) => {
    setFormData(prev => {
      ...
      if (errors.platforms) setErrors(errs => ({ ...errs, platforms: null }));
  ...
  const handleSubmit = () => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      // Scroll to top or first error (simplified for now)
  ...
  return (
    <div className="relative pb-24">
      ...
      <div className="p-8 max-w-[1000px] mx-auto space-y-6">
        ...
        <SectionCard title="1. Brief Information">
